<?php namespace App\Http\Controllers;
	...
	class AdminServices14Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cost','name'=>'cost','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
